  ...
  return (
    <>
      <tr className="py-2 h-14 sticky top-0 border-b cursor-pointer hover:bg-slate-50">
        <td className="h-7 pl-5 pr-1 text-gray-800 font-semibold">
          {studentName}
        </td>
        ...
        <td className="h-7 pl-5 pr-1 text-gray-500 font-medium">{mobileNo}</td>
        <td className="h-7 pl-5 pr-1 text-gray-500 font-medium">{addharNo}</td>
        <td className="h-7 text-gray-500 w-5">
          <div className="flex items-center justify-around h-7 gap-x-2 px-2">
            <Link to={`/dashboard/instructor/features/students/details/${id}`}>
            ...
            <Link
              to={
                authDashboardUser.role === "admin" ||
                authDashboardUser.role === "instructor"
                  ? `/dashboard/instructor/features/students/edit/${id}`
                  : ""
              }
            >
              <svg
