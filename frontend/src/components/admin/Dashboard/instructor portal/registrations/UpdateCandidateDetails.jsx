...
import useUpdateCandidateDetails from "../../../../../hooks/admin/instructor portal/useUpdateCandidateDetails";
...
const UpdateCandidateDetails = ({ candidateId }) => {
  ...
  useEffect(() => {
    ...
    courseDetails
      ...
      .then((response) => {
        return setInputs({ ...response, id: response._id });
      });
  }, [candidateId]);
  ...
  const handleSubmit = async (e) => {
    ...
    await candidateDetailsForm(inputs);
    setInputs({
      id: "",
      courseName: "",
      candidateName: "",
  ...
  return (
    <>
      <div className="flex items-center justify-between w-full mx-auto my-3 flex-wrap">
        <h2 className="text-2xl font-bold mb-2">Update Candidate Details</h2>{" "}
            ...
            <div className="inputBox my-2 w-full sm:w-auto">
              ...
              <div className="px-2 my-2 w-full sm:w-72  h-10 rounded border-2 border-slate-50 py-1 bg-slate-50 shadow shadow-slate-700 flex items-center justify-start">
                <input
                  ...
                  onChange={(e) =>
                    setInputs({ ...inputs, candidateName: e.target.value })
                  }
                  id="candidateName"
                  name="candidateName"
                />
