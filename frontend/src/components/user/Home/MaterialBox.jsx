...
const MaterialBox = ({ id, title, desc, tag, fileBanner }) => {
  return (
    <>
      <div className=" w-[19rem] h-64 rounded-lg bg-[#F7F8F8] drop-shadow shadow-lg relative mx-auto transition-all hover:shadow-xl hover:shadow-gray-400">
