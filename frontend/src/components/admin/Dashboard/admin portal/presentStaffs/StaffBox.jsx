  ...
  return (
    <>
      <div className="instructor-card py-2 px-4 bg-white shadow-lg shadow-gray-400 rounded-xl cursor-default relative">
        ...
        <div>
          <div className="w-20 h-20 mx-auto my-2 border rounded-full overflow-hidden object-fill">
            <img src={profilePic} alt="image" className="w-full h-full" />
          </div>
        </div>
        <div className="mx-auto">
          <h2 className="text-center text-base mt-4 text-color-cyan">
            <b>{fullname}</b>
          </h2>
          <h4 className="text-center text-sm text-color-cyan">
            {specilization[0]}
          </h4>
        ...
        <div className="w-full h-12 flex items-center justify-around mt-8 flex-wrap">
          <Link to={`/dashboard/admin/staff/${id}`}>
            {" "}
            <button className="text-center mr-1 px-9 text-color-cyan py-3 bg-white border-color-cyan rounded-xl text-sm hover:shadow-md hover:shadow-slate-500">
              Explore
            </button>
          </Link>
          <Link to={`/dashboard/admin/staff/update/${id}`}>
            <button className="text-center ml-1 px-9 text-white py-3 bg-color-cyan border-color-cyan rounded-xl text-sm hover:shadow-md hover:shadow-slate-500">
              Edit Now
            </button>
          </Link>
        </div>
