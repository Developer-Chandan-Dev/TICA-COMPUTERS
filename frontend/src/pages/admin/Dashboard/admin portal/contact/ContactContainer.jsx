...
import Contact from "../../../../../components/admin/Dashboard/admin portal/contact/Contact";
import ContactDetails from "../../../../../components/admin/Dashboard/admin portal/contact/ContactDetails";

const ContactContainer = () => {
  const data = useSelector((state) => state.contactData.value);
  ...
  return (
    <>
      <section className="w-full relative mx-auto pt-0 pb-5 ">
        <div className="flex items-start justify-between gap-x-6 w-full relative enquiryContainer h-[530px]">
          <div className="bg-white shadow-md shadow-slate-200 enquiryBox w-full lg:w-2/3 relative">
            <h1 className="py-4 px-6 text-gray-500 border-b">Contacts</h1>
