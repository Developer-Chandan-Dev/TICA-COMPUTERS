...
import { formatDate } from "../../instructor portal/dateUtils";
import { setContactData } from "../../../../../features/admin/ContactData/contactDataSlice";
...
const ContactInfo = ({
  ...
  const handleClick = () => {
    dispatch(
      setContactData({ name, email, phone, address, createdAt, message })
    );
  };
        ...
        <div className="text-box active-text-box">
          <div className="flex items-center justify-between">
            ...
            <svg
              ...
              viewBox="0 0 16 16"
              onClick={() =>
                onDelete(id, `${VITE_API_URL}/api/v1/admin/contact`, setData, data, "contact")
              }
            >
