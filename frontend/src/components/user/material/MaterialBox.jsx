...
const MaterialBox = ({
  ...
  return (
    <div className=" w-[19rem] mx-auto sm:mx-0 h-64 rounded-lg bg-[#F7F8F8] drop-shadow shadow-lg relative transition-all hover:shadow-xl hover:shadow-gray-400 pt-2">
      ...
      <div className="px-5 mx-auto text-center">
        ...
        <p className=" text-[15px] text-[#A2A1A1] my-1">{desc.length > 50 ? desc.slice(0, 50) + "..." : desc}</p>
        <div className="mt-2">
